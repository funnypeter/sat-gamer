...
export default function StudentJoinPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const setupResp = await fetch("/api/auth/join", {
        method: "POST",
      ...
      // Set role cookie
      document.cookie = `user_role=student; path=/; max-age=${60 * 60 * 24 * 30}`;
      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="w-full max-w-md text-center space-y-6">
          ...
          <div className="card-glass p-8 space-y-4">
            ...
            <h2 className="text-xl font-bold text-white">Invalid Invite Code</h2>
            <p className="text-gray-400">
              This invite link doesn&apos;t seem to be valid. Ask your parent for the correct link.
            </p>
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Create your student account to start earning screen time
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card-glass p-8 space-y-6">
          ...
          >
            {loading ? "Joining..." : "Join & Start Playing"}
          </button>
        </form>
